...
//nire mac konstantearentzat typedefa
//typedef bit<48>  mac_ha;
...
//MQTT parseatzeko TCPko portua begiratuko dut. Beraz konstatea izango da hau 1883 (HEX:0x75b)
const bit<16> MQTT_DST_PORT    = 1883;

//mqtt mezuarentzat datuak bilitegiratzeko aldagaia deklaratu 9 bytekin
// =6 jartzen det ze ip vesioa wiresharkeko harrapaketattan 6 jartzen du
...
// konstantiei baliyue eman
const bit<48> mac_ha  = 0x00_00_00_00_00_1B;

//MAC ADRRESS KONSTANTEAK H1 ETA H2REN PINGAK KONTROLATZEKO
//const mac_hb IPV6_MCAST_01 = 0x00_00_00_00_00_1A;
                   ...
                   inout standard_metadata_t standard_metadata)
{
    ...
    state parse_tcp {
        ...
        transition select(hdr.tcp.dst_port){
            MQTT_DST_PORT: parse_tcpOptions;
            default: accept;
        }
    }

    state parse_tcpOptions {
            packet.extract(hdr.tcpOptions);
    ...
    state parse_mqtt {
        ...
        //local_metadata.mqttMesaage = hdr.mqtt.message;
        transition accept;
        }
...
control IngressPipeImpl (inout parsed_headers_t    hdr,
    ...
    //HOST A-KO PINGAK BAZTERTZEKO TABLE-A
    //table ping_deny {
        //key = {
        //    hdr.ethernet.src_addr:          ternary;
        //}
   ...
   // }
    ...
    apply {
        ...
        //jatorria hc bada ez da bideratuko
        if (hdr.mqtt.message == 0x35){
            //drop();
            do_l3_l2 = false;
        ...
        //MQTTrekin froga
        //tenperatura 6 bada ez uztea pasatzen adibidez
        //if (hdr.mqtt.message == 6){
        //do_l3_l2 = false;
        //}

        if (do_l3_l2) {

            //Baztertu jatorria hb baldin bada
            //if(hdr.ethernet.isValid() && hdr.ethernet.src_addr == 0x00_00_00_00_00_1B){drop();}
            //drop();
